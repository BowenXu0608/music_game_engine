    ...
    <Surface>
      ...
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        ...
        <div style={{ width: 296, borderLeft: '1px solid var(--border)', display: 'flex', flexDirection: 'column' }}>
          <Tabs
            items={[{ id: 'p', label: 'Properties', icon: I.settings }]}
            value="p"
            onChange={()=>{}}
          />
        ...
        {/* Copilot — chart/page edits via prompts */}
        <CopilotPanel
          accent="cyan"
          greeting="Describe a start-screen tweak — e.g. 'make the logo pulse with the beat', 'use a slow fade transition'."
          placeholder="Ask Copilot to edit this page…"
        />
      </div>

      {/* Pinned bottom Assets strip — drag onto preview / property slots */}
      <AssetStrip />
    </Surface>
  );
}
